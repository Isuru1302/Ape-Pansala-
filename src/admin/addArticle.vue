      ...
      <div class="main-panel">
        ...
        <div class="content">
          <div class="container-fluid">
            ...
            <form @submit.prevent="addArticle" class="addarticle-table">

              <p>Article Title:</p>
              <input type="text" v-model="article_details.title" >

              <p>Article Content:</p>
              <ckeditor :editor="editor" v-model="article_details.content"  :config="editorConfig"></ckeditor>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      addArticle(){
        this.$http.post('http://localhost:8000/api/addArticle',this.article_details)
      ...
      getImage1(e){
        ...
        fileReader.onload = (e)=>{
          this.article_details.img1 = e.target.result;
        }
      ...
      getImage2(e){
        ...
        fileReader.readAsDataURL(e.target.files[0]);
        fileReader.onload = (e)=>{
          this.article_details.img2 = e.target.result;
        }
      },
      ...
      getImage3(e){
        ...
        fileReader.readAsDataURL(e.target.files[0]);
        fileReader.onload = (e)=>{
          this.article_details.img3 = e.target.result;
        }
      },
      ...
      getImage4(e){
        ...
        fileReader.readAsDataURL(e.target.files[0]);
        fileReader.onload = (e)=>{
          this.article_details.img4 = e.target.result;
        }
      },
